...
<div class="pos-shell">
    <div class="pos-top">
        ...
        <div class="dropdown-wrap">
            <button class="btn" id="optionsButton" type="button">Opciones</button>
        ...
        <div class="modal-body">
            ...
            <div id="referenceWrap" style="display:none;">
                ...
                <div class="info-card" id="electronicSimulationHelp" style="font-size:14px; line-height:1.45;">
                    ...
                    Probar una simulación para rechazar tarjeta uitilicé las siguientes palabras
...
<script>
    ...
    function buildElectronicReference() {
        ...
        if (paymentMethod === 'TARJETA') {
            return `BANCO:${bank} | TARJETA:${cardLast4} | AUT:${reference}`;
        }

        return `BANCO:${bank} | REF:${reference}`;
    }
    ...
    async function openCash() {
        ...
        try {
            ...
            isOpeningCash = false;
            setButtonLoading('openCashButton', false, 'Abriendo...');
        }
    }
    ...
    async function openShift() {
        ...
        try {
            ...
            setButtonLoading('openShiftButton', false, 'Iniciando...');
        }
    }
    ...
    async function confirmCloseShift() {
        ...
        try {
            ...
            setButtonLoading('confirmCloseShiftButton', false, 'Cerrando...');
        }
    }
    ...
    async function confirmCloseCash() {
        ...
        try {
            ...
            isClosingCash = false;
            setButtonLoading('confirmCloseCashButton', false, 'Cerrando...');
        }
    }
    ...
    async function confirmSale() {
        ...
        try {
            ...
            setButtonLoading('confirmSaleButton', false, 'Procesando...');
            renderPaymentTotals();
        }
    }
