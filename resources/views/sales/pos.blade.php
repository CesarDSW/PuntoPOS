...
<head>
    ...
    <style>
        * { box-sizing:border-box; margin:0; padding:0; font-family:Arial, sans-serif; }
        ...
        .product-card:hover { border-color:#1d4ed8; }
        .product-name { font-weight:700; margin-bottom:10px; }
        .product-price { color:#1d4ed8; font-size:18px; font-weight:700; }
        .product-stock { color:#64748b; font-size:13px; margin-top:10px; text-align:right; }
        ...
        .dot-card { background:#1d4ed8; }
        .dot-cash { background:#0f172a; }
        .dot-transfer { background:#6b7280; }
        ...
        .shift-open-user-name {
            font-size:18px;
            font-weight:700;
        }

        .shift-open-user-role {
            color:#64748b;
            font-size:14px;
            margin-top:4px;
        }

        .shift-open-info-card {
            border:1px solid #e5e7eb;
            border-radius:16px;
            padding:16px;
            display:flex;
        ...
        .shift-open-info-label {
            color:#64748b;
            font-size:13px;
            margin-bottom:6px;
        }

        .shift-open-info-value {
            font-size:18px;
            font-weight:700;
        }
        ...
        .shift-open-checks-title {
            font-size:18px;
            font-weight:700;
            margin-bottom:12px;
        }

        .shift-open-check-list {
            display:flex;
            flex-direction:column;
            gap:12px;
            color:#64748b;
        ...
        @media (max-width: 1100px) {
            ...
            .shift-top-grid { grid-template-columns:1fr; }
